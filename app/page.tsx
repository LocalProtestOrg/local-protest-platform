...
export const metadata: Metadata = {
  ...
  // Next will render a meta name="keywords"
  keywords: [
    ...
    "political action near me",
    "community action",
    "find protests by city",
    "find rallies by state",
    "activism events near me",
  ...
  // Helps avoid phone number auto-linking and similar formatting oddities
  formatDetection: {
    telephone: false,
    address: false,
    email: false,
  ...
  // If you have these assets, great. If not, remove or adjust.
  icons: {
    icon: [
      { url: "/favicon.ico" },
  ...
  // Extra meta tags that can help in practice (non-standard but commonly used)
  other: {
    ...
    // OpenGraph extras some scrapers use
    "og:image:secure_url": OG_IMAGE,
    "og:image:alt": "Local Assembly civic event listings",

    // Optional: If you later add a site-wide verification, put it in your root layout instead.
    // "google-site-verification": "PASTE_TOKEN_HERE",
    // "msvalidate.01": "PASTE_TOKEN_HERE",
  },
};
...
export default async function HomePage({ searchParams }: PageProps) {
  ...
  // Stronger JSON-LD: fix URL typo, add Organization, and keep ItemList
  const jsonLd = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        about: "Civic engagement and public events directory",
        description:
