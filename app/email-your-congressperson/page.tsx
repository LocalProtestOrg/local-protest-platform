          ...
          <div className="space-y-6 md:col-span-1">
            ...
            >
              ...
              <div className="mt-4 rounded-md border border-neutral-200 bg-neutral-50 p-3 text-xs text-neutral-700">
                ...
                <p className="mt-1">
                  Senate offices often ask you to include a return mailing address to confirm you’re a constituent.
                </p>
              </div>
            </Card>
            ...
            >
              <p className="text-sm text-neutral-600">
                Today’s page is state-based (simple + safe). The next step is an address/ZIP flow
                that returns your exact delegation.
              </p>
              <div className="mt-4">
                <Link
                  href="/"
            ...
            >
              <div className="grid gap-3 text-sm text-neutral-700">
                <div className="rounded-md border border-neutral-200 p-4">
                  ...
                  <p className="mt-1">“I live in [City], and I’m a constituent in your district/state.”</p>
                </div>
                <div className="rounded-md border border-neutral-200 p-4">
                  <p className="font-medium text-neutral-900">2) What you want</p>
                  <p className="mt-1">
                    One clear request: “Please support/oppose [X]” or “Please take action to [Y].”
                  </p>
                </div>
                <div className="rounded-md border border-neutral-200 p-4">
                  <p className="font-medium text-neutral-900">3) Why locally</p>
                  <p className="mt-1">
                    A short local impact story (2–4 sentences) is often more persuasive than a long essay.
                  </p>
                </div>
              </div>
            </Card>
